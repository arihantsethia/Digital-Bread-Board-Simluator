...
<div class="login_wrapper">
    ...
    <div class="login" style="height:250px;">
        <div id="login_avatar_wrapper" style="width: 125px; height: 250px; float:left; margin-top:65px;">
            ...
            <div style="width: 124px; height: 125px; float:right; margin:0; border-right: 0px solid #e6e6e6;">
            </div>
        </div>
