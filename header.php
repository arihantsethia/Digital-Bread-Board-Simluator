...
<html>
    <head>
        <meta charset="utf-8">
		<title>Digital Bread Board Simulator</title>
        <!-- webfonts -->
        <link href='http://fonts.googleapis.com/css?family=Droid+Sans:400,700' rel='stylesheet' type='text/css'>
        <!-- css -->
        <link href='css/stylephp.css' rel='stylesheet' type='text/css' /><!-- the path is always relative to index.php -->	
        ...
        <script src="js/beautiful_login.js" type="text/javascript"></script>    
<!-- CSS -->
