	...
	<body style="background: #f1f1f1 url(../img/bg/patterns/noise.png);>
				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							<li class="home.html"><a href="home.php">Home<span class="subheader">Welcome</span></a></li>
							...
							<li class="current-menu-item"><a href="software.php">Software<span class="subheader">Experiment</span></a></li>
						</ul>
						<!-- Navigation -->
					</div>
					<!-- wrapper-menu -->
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- headline -->
					<div id="headline" style=" margin-bottom:15px">
						<span class="main">Documentation</span>
						<span class="sub">Click On The Button To Download The Documentation </span>
						<a href="Documentation-DigitalBreadBoardSimulator_CS241.pdf" id="link" class="link-button-big"><span>Download</span></a>
						
					</div>
					<div id="headline" style="padding-bottom:2px; margin-bottom:2px">
						<span class="main">Download The Software</span>
						<span class="sub">Click On The Button To Download The Software </span>
						<a href="DBBS.zip" id="link" class="link-button-big"><span>Download</span></a>
						
					</div>
								
					<div id="headline" style="padding-bottom:2px; margin-bottom:12px">
						<span class="main">Upload The File</span>
						<span class="sub">Click On The Button To Upload The File 
						<form enctype="multipart/form-data" action="upload.php" method="POST" style="float:right">
							<input type="hidden" name="MAX_FILE_SIZE" value="512000" />
							<input name="userfile" id="link"  style="border:none; margin-right:100px;font-family: 'Ubuntu', arial, serif; font-size: 18px;line-height: 1.5em; " type="file" />
							<input type="submit" id="link" class="link-button-big" style="border:none; margin-top:-5px; display: block;font-family: 'Ubuntu', arial, serif; font-size: 18px;
	line-height: 1.5em;" value="Upload" /></span>
					</div>
